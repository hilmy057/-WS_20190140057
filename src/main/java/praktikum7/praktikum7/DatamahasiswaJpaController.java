...
import praktikum7.praktikum7.exceptions.NonexistentEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("data.mhs.pws.b_data.mhs.pws.a_jar_0.0.1-SNAPSHOTPU");

    DatamahasiswaJpaController() { //To change body of generated methods, choose Tools | Templates.
    }
